...
<div class="page-header">
    <div>
        <h1 class="page-title">إضافة اشتراك حكومي</h1>
        <p class="page-subtitle">تسجيل اشتراك جديد في منصة حكومية</p>
    </div>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="<?= url('gov_subscriptions', 'store') ?>">
            <?= csrfField() ?>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="hidden" name="platform" id="platformFinal">
                </div>
                <div class="form-group">
                    ...
                    <select name="company_id" class="form-control" id="companySelect" onchange="updateCompanyName()">
                        ...
                        <?php foreach ($companies as $c): ?>
                            <option value="<?= $c['id'] ?>" data-name="<?= clean($c['name_ar']) ?>"><?= clean($c['name_ar']) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="company_name" id="companyNameInput" class="form-control" required placeholder="اسم الشركة المسجل في المنصة">
                </div>
                <div class="form-group">
                    <label class="form-label">رقم الاشتراك</label>
                    <input type="text" name="subscription_number" class="form-control" dir="ltr" placeholder="مثال: Q-456789">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="password_hint" class="form-control" placeholder="ملاحظة تذكيرية (لا تكتب كلمة المرور الفعلية)">
                </div>
            </div>
